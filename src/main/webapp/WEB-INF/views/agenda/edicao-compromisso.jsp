...
<body>
	...
	<h5>Formúlario para edição de Compromisso</h5>
	Preencha os campos abaixo para atualizar um compromisso.
	<br>
	<br>

	<form autocomplete="off" id="formCadastro">
	<input type="hidden" name="idCompromisso" id="idCompromisso"/>
			...
			<div class="col-md-7">
				<div class="row">
					<div class="col-md-6">
						...
						<label>Data do Compromisso:</label> <input type="date"
							name="dataCompromisso" id="dataCompromisso" class="form-control" />
					</div>
					<div class="col-md-6">

						<label>Hora do Compromisso:</label> <input type="text"
		...
		<div class="row">
			<div class="cold-md-3">
				<label>Tipo do Compromisso</label> <select name="tipo" id="tipo"
					class="form-control">
			...
			<div class="cold-md-3">
				<label>Prioriadade do Compromisso</label> <select name="prioridade"
					id="prioridade" class="form-control">
					<option value="">Escolha uma opção</option>
				</select>
			</div>
		</div>
